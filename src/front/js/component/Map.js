...
const Map = () => {
  ...
  return (
    <MapContainer center={[-32.818055555556, -56.506388888889]} zoom={7} style={{ width: "100vw", height: "100vh" }}> {/* //Asi se centra el mapa en un lugar: -34.91709426939976, -56.16318765994477 */}
      <TileLayer
